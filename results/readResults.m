...
%% Reactive Power
figure(21);bar([PcQcTAble_OID.store_Gug_Qc(:,3) PcQcTAble_VAR.store_VAR_Qc(:,3) PcQcTAble_noCont.store_Gug_Qc(:,3)],'DisplayName','PcQcTAble_OID.store_Gug_Pg')
...
set(gcf,'color','w');  
% Active Power
figure(22);bar([PcQcTAble_OID.store_Gug_Pc(:,3) PcQcTAble_VAR.store_VAR_Pc(:,3) PcQcTAble_noCont.store_Gug_Pc(:,3)],'DisplayName','PcQcTAble_OID.store_Gug_Pg')
legend({'OID', 'Volt/VAR', 'No Control'})
%ylim([0 0.05])
xlabel('Time')
...
grid on
set(gcf,'color','w');  
figure(23);bar([PcQcTAble_OID.store_Gug_Qg(:,3) PcQcTAble_VAR.store_VAR_Qg(:,3) PcQcTAble_noCont.store_Gug_Qg(:,3)],'DisplayName','PcQcTAble_OID.store_Gug_Pg')
legend({'OID', 'Volt/VAR', 'No Control'})
%ylim([0 0.05])
xlabel('Time')
ylabel('Reactive Power [kVAR]')
...
set(gcf,'color','w');  
% Active Power
figure(24);bar([PcQcTAble_OID.store_Gug_Pg(:,3) PcQcTAble_VAR.store_VAR_Pg(:,3) PcQcTAble_noCont.store_Gug_Pg(:,3)],'DisplayName','PcQcTAble_OID.store_Gug_Pg')
legend({'OID', 'Volt/VAR', 'No Control'})
%ylim([0 0.05])
xlabel('Time')
...
set(gcf,'color','w'); 
% voltage profile
figure(25);plot(1:48, [VoltageTable_OID.store_Gug_V18(:,3) VoltageTable_VAR.store_VAR_V18(:,3) VoltageTable_noCont.store_Gug_V18(:,3)],'DisplayName','VoltageTable_OID.store_Gug_Pg')
legend({'OID', 'Volt/VAR', 'No Control'})
%ylim([0 0.05])
xlabel('Time')
...
f32 = figure(32)
ret = duration_plot([VoltageTable_OID.store_Gug_V18(:) VoltageTable_VAR.store_VAR_V18(:) VoltageTable_noCont.store_Gug_V18(:)], f32, 'x_label','% of time', 'y_label','Voltage Mangnitude [p.u.]', 'Legend', {'OID','Volt/VAR', 'No Control'}, 'title', 'Voltage Duration Curve')
%% ============  Reative Power vs Voltage Magnitude (Volt/Var)
f33 = figure(33);
movegui(f33,'northeast');        
scatter(VoltageTable_OID.store_Gug_V18(:), abs(PcQcTAble_OID.store_Gug_Qc(:)),'b*', 'DisplayName','VoltageTable_OID.store_Gug_V18')
hold on 
...
scatter(VoltageTable_OID.store_Gug_V18(:), abs(PcQcTAble_OID.store_Gug_Pc(:)),'b*', 'DisplayName','VoltageTable_OID.store_Gug_V18')
hold on 
